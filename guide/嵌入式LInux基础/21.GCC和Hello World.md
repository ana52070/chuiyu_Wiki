---
title: GCC和Hello World
author: chuiyu
date: 2026-02-05 08:00:00
description: 21.GCC和Hello World
tags:
  - 嵌入式Linux基础
permalink: /pages/160f6b
categories:
  - guide
  - 嵌入式LInux基础
---
...
![系统自带的GCC编译器](assets/gcchel002.png)
...
![Binutils工具集的部分内容](assets/gcchel003.png)
...
![直接运行glibc函数库查看其版本](assets/gcchel004.png)
...
hello.c文件（embed_linux_base_tutorial_code_imx6/base_code/linux_app/hello_c/hello.c）
...
![GCC安装编译工具链](assets/gcchel011.png)
...
![Debian GCC](assets/gcchel012.png)
...
![直接使用VS Code打开*.o文件的提示](assets/gcchel007.png)
...
![使用readelf查看*.o目标文件（部分内容）](assets/gcchel008.png)
...
![动态链接和静态链接的区别](assets/gcchel009.png)
...
![使用ldd工具查看动态文件的库依赖](assets/gcchel010.png)
