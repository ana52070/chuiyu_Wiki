---
title: 'chuiyu_Wiki'
date: '2026-03-23 14:00:56'
categories:
  - '软件项目'
tags:
  - 'GitHub'
permalink: '/projects/chuiyu-wiki'
repo: 'ana52070/chuiyu_Wiki'
description: 'Chuiyu Wiki 是一个基于 VitePress 构建的个人知识库与博客系统。这里记录了我在学习和开发过程中的点滴积累，涵盖了嵌入式开发、人工智能、Linux 系统、ROS2 等多个领域的技术笔记与项目实战。  本项目采用了 vitepress-theme-teek 主题，界面简洁美观，支持多种自定义配置。'
homepage: 'https://chuiyu.wiki'
stars: 3
language: 'Python'
license: ''
created_at: '2026-02-03T08:30:40Z'
updated_at: '2026-03-22T13:32:01Z'
topics:
  - '暂无'
---
...
- 仓库：[https://github.com/ana52070/chuiyu_Wiki](https://github.com/ana52070/chuiyu_Wiki)
- Star：3
- 主语言：Python
- README 来源：`README.md` (分支：`main`)
...
<p align="center">
  <img src="https://raw.githubusercontent.com/ana52070/chuiyu_Wiki/main/logo.jpg" alt="Logo" width="120" height="120" style="border-radius: 50%;">
</p>
...
本项目采用 [ISC License](https://github.com/ana52070/chuiyu_Wiki/blob/main/LICENSE) 许可证。
